    ...
    <div class="container" style="width: 900px;">
        ...
        <form action="{{ route('event.store') }}" method="POST" style="width: 60%; margin:auto;">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="organize" name="organize" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="place" name="place" placeholder="例：松山" required>
            </div>
            <div class="mb-3">
                <label for="event_date" class="form-label">日時</label>
                <input type="text" class="form-control" id="event_date" name="event_date" placeholder="例：2022-02-11" required>
            </div>
            <div class="mb-3">
                <label for="address" class="form-label">住所</label>
                <input type="text" class="form-control" id="adress" name="address" placeholder="例：愛媛県松山市山越2丁目1番6号" required>
            </div>
            <div class="mb-3">
                <label for="parttime" class="form-label">イベント時間</label>
                <input type="text" class="form-control" id="parttime" name="parttime" placeholder="例：13:00~15:00" required>
            </div>
            <div class="mb-3">
