...
$(function () {
  ...
  $('.js-like').click(function () {
    ...
    if (like_id) {
      ...
      .done(function () {
        this_obj.data('like-id', null); // いいね！ボタンをデフォルトにする
      ...
      .done(function (data) {
        this_obj.data('like-id', data['like_id']); // いいね！ボタンを濃くする
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\and_cat\resources\js\like.js */"./resources/js/like.js");
